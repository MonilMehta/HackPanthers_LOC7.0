...
const registerUser = asyncHandler( async ( req, res ) => {
    ...
    const {username, email, date_of_birth,gender, phone_no, address, fullname, password, role, policeDetails, avaliableLeave, usedLeave} = req.body;
    ...
    const user = await User.create({
        username: username.toLowerCase(), email, date_of_birth, gender, phone_no, address, fullname, password, role, policeDetails, avaliableLeave, usedLeave
    })
